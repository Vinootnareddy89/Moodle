...
$CFG->dbhost    = 'database-1.c5w7sxqy10x5.us-east-1.rds.amazonaws.com';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'Moodle';     // database name, eg moodle
$CFG->dbuser    = 'admin';   // your database username
$CFG->dbpass    = 'Asqw123$';   // your database password
...
$CFG->wwwroot   = 'http://54.89.51.73/moodle';
